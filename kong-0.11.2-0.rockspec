...
build = {
  ...
  modules = {
    ...
    ["kong.api.routes.labels"] = "kong/api/routes/labels.lua",
    ...
    ["kong.dao.schemas.labels"] = "kong/dao/schemas/labels.lua",
    ["kong.dao.schemas.labels"] = "kong/dao/schemas/label_mappings.lua",
