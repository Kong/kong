...
- When using Kong in hybrid mode, Kong Manager now provides a page to list all the data planes in the cluster under the newly added "Data Plane nodes" tab.
 [#214](https://github.com/Kong/kong-manager/issues/214)


- Kong Manager now supports setting log levels with timeouts in bulk for data planes under the hybrid mode.
 [#214](https://github.com/Kong/kong-manager/issues/214)
