  ...
  describe("POST", function()
    for i, v in ipairs(ENDPOINTS) do
      describe(v.collection, function()
        ...
        it("should respond 400 to malformed application/json body", function()
          local response, status = http_client.post(spec_helper.API_URL.."/"..v.collection.."/", '{"hello":"world"', {["content-type"] = "application/json"})
          assert.are.equal(400, status)
