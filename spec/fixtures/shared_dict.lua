...
return
  ...
  "--shdict 'kong_core_db_cache 16m' " ..
  "--shdict 'kong_core_db_cache_miss 16m' " ..
  ...
  "--shdict 'stream_kong_core_db_cache 16m' " ..
  "--shdict 'stream_kong_core_db_cache_miss 16m' " ..
