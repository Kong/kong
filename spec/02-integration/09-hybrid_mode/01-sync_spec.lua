...
describe("CP/DP #version check #" .. strategy, function()
  ...
  describe("relaxed compatibility check:", function()
    ...
    local plugin_list = kong_table.cycle_aware_deep_copy(helpers.get_plugins_list())
    ...
    local pl1 = kong_table.cycle_aware_deep_copy(helpers.get_plugins_list())
    ...
    local pl2 = kong_table.cycle_aware_deep_copy(helpers.get_plugins_list())
    ...
    local pl3 = kong_table.cycle_aware_deep_copy(helpers.get_plugins_list())
