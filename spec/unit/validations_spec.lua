  ...
  describe("#validate()", function()
    ...
    describe("Sub-schemas", function()
      ...
      it("should validate a property with a sub-schema", function()
        ...
        assert.truthy(err)
        assert.falsy(valid)
        assert.are.same("sub_field_required is required", err["sub_field_required"])
      end)
      ...
      it("should validate a property with a sub-schema from a function", function()
        ...
        assert.truthy(err)
        assert.falsy(valid)
        assert.are.same("sub_sub_field_required is required", err["sub_sub_field_required"])
      end)
      ...
      it("should retrieve errors when cannot load schema from function", function()
        ...
        assert.truthy(err)
        assert.falsy(valid)
        assert.are.same("Error loading the sub-sub-schema", err["sub_sub_schema"])
      end)
