...
describe(PLUGIN_NAME .. ": (unit)", function()
  ...
  describe("chat v1 operations", function()
    ...
    it("adds messages to the start of the array", function()
      ...
      local code, err = access_handler.execute(request_copy, injector_conf_prepend)

      assert.is_nil(code)
      assert.is_nil(err)
      assert.same(expected_request_copy, request_copy)
    end)
    ...
    it("adds messages to the end of the array", function()
      ...
      local code, err = access_handler.execute(request_copy, injector_conf_append)
    ...
    it("adds messages to the start and the end of the array", function()
      ...
      local code, err = access_handler.execute(request_copy, injector_conf_both)
