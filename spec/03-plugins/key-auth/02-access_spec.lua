...
describe("Plugin: key-auth", function()
  ...
  describe("#o Unauthorized", function()
  ...
  describe("#o key in querystring", function()
  ...
  describe("#o key in headers", function()
    it("authenticates valid credentials", function()
      local res = assert(client:send {
        method = "GET",
        path = "/request",
  ...
  describe("#o Consumer headers", function()
  ...
  describe("#o config.hide_credentials", function()
