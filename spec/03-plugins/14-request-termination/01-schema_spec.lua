...
describe("Plugin: request-termination (schema)", function()
  ...
  it("should accept a trigger value", function()
    assert(v({trigger_value = "Test Trigger"}, schema_def))
  end)
  it("should accept avert", function()
    assert(v({ echo = true, avert = "header_name" }, schema_def))
  end)
  it("should accept a avert value", function()
    assert(v({avert_value = "Test Avert"}, schema_def))
  end)
