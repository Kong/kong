...
for _, strategy in helpers.each_strategy() do
  describe("Plugin: datadog (log) [#" .. strategy .. "]", function()
    ...
    it("logs metrics over UDP", function()
      ...
      assert.contains("kong.dd1.request.count:1|c|#app:kong,consumer_id:bar", gauges)
    ...
    it("logs metrics over UDP with custom prefix", function()
      ...
      assert.True(ok)
      assert.equal(12, #gauges)
      assert.contains("prefix.dd4.request.count:1|c|#app:kong,consumer_id:bar",gauges)
