  ...
  describe(PLUGIN_NAME .. ": (access) [#" .. strategy .. "]", function()
    ...
    describe("azure llm/v1/chat", function()
      ...
      it("bad request", function()
        ...
        -- check this is in the 'kong' response format
        assert.is_truthy(json.error)
        assert.equals(json.error.message, "'messages' is a required property")
      end)
    end)
    ...
    describe("azure llm/v1/completions", function()
      ...
      it("bad request", function()
        ...
        -- check this is in the 'kong' response format
        assert.is_truthy(json.error)
        assert.equals("you must provide a 'prompt' parameter", json.error.message)
      end)
    end)
  end)
