  ...
  describe(PLUGIN_NAME .. ": (access) [#" .. strategy .. "]", function()
    ...
    lazy_setup(function()
      ...
      local chat_good_with_no_upstream_port = assert(bp.routes:insert {
        ...
        protocols = { "http" },
        strip_path = true,
        paths = { "/mistral/llm/v1/chat/good_with_no_upstream_port" }
      })
      bp.plugins:insert {
        name = PLUGIN_NAME,
    ...
    describe("mistral llm/v1/chat", function()
      ...
      it("good request with no upstream port", function()
        local r = client:get("/mistral/llm/v1/chat/good_with_no_upstream_port", {
          headers = {
            ["content-type"] = "application/json",
            ["accept"] = "application/json",
          },
        ...
        -- validate that the request succeeded, response status 502
