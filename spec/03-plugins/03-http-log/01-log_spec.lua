...
for _, strategy in helpers.each_strategy() do
  for buffering_request, buffering_response, buffering_label in helpers.each_buffering() do
    describe("Plugin: http-log (log) [#" .. strategy .. "](".. buffering_label ..")", function()
      local proxy_client
    ...
    for _, workers in ipairs({1, 4}) do
      describe("Plugin: http-log (log) queue (worker_processes = " .. workers .. ") [#" .. strategy .. "](".. buffering_label ..")", function()
        local proxy_client
