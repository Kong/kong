...
for _, strategy in helpers.each_strategy() do
  for buffering_request, buffering_response, buffering_label in helpers.each_buffering() do
    for _, policy in ipairs({"local", "cluster", "redis"}) do
      ...
      describe(fmt("#flaky Plugin: response-ratelimiting (access) with policy: #%s [#%s](%s)", policy, strategy, buffering_label), function()
      ...
      describe(fmt("#flaky Plugin: response-ratelimiting (expirations) with policy: #%s [#%s](%s)", policy, strategy, buffering_label), function()
      ...
      describe(fmt("#flaky Plugin: response-ratelimiting (access - global for single consumer) with policy: #%s [#%s](%s)", policy, strategy, buffering_label), function()
      ...
      describe(fmt("#flaky Plugin: response-ratelimiting (access - global) with policy: #%s [#%s](%s)", policy, strategy, buffering_label), function()
      ...
      describe(fmt("#flaky Plugin: response-ratelimiting (fault tolerance) with policy: #%s [#%s](%s)", policy, strategy, buffering_label), function()
