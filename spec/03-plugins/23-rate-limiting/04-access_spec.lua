...
for _, strategy in helpers.each_strategy() do
  for buffering_request, buffering_response, buffering_label in helpers.each_buffering() do
    for _, policy in ipairs({ "local", "cluster", "redis" }) do
      describe(fmt("Plugin: rate-limiting (access) with policy: %s [#%s](%s)", policy, strategy, buffering_label), function()
        local bp
        local db
      ...
      describe(fmt("Plugin: rate-limiting (access - global for single consumer) with policy: %s [#%s](%s)", policy, strategy, buffering_label), function()
        local bp
        local db
      ...
      describe(fmt("Plugin: rate-limiting (access - global for service) with policy: %s [#%s](%s)", policy, strategy, buffering_label), function()
        local bp
        local db
      ...
      describe(fmt("Plugin: rate-limiting (access - per service) with policy: %s [#%s](%s)", policy, strategy, buffering_label), function()
        local bp
        local db
      ...
      describe(fmt("Plugin: rate-limiting (access - global) with policy: %s [#%s](%s)", policy, strategy, buffering_label), function()
        local bp
        local db
      ...
      describe(fmt("Plugin: rate-limiting (access - global) with policy: %s [#%s](%s) by path", policy, strategy, buffering_label), function()
        local bp
        local db
