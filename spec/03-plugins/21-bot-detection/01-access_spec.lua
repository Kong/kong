...
for _, strategy in helpers.each_strategy() do
  for buffering_request, buffering_response, buffering_label in helpers.each_buffering() do
    describe("Plugin: bot-detection (access) [#" .. strategy .. "](".. buffering_label ..")", function()
      local proxy_client
    ...
    describe("Plugin: bot-detection configured global (access) [#" .. strategy .. "](".. buffering_label ..")", function()
      local proxy_client
