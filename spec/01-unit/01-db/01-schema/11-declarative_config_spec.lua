...
describe("declarative config", function()
  ...
  lazy_setup(function()
    DeclarativeConfig, DeclarativeConfig_def = assert(declarative_config.load(helpers.test_conf.loaded_plugins))
  end)
            ...
            ["services"] = {
              {
                ["routes"] = {
                  {
                    ["@entity"] = { "must set one of 'methods', 'hosts', 'paths' when 'protocols' is 'http' or 'https'" }
                  }
                }
              }
            }
