  ...
  describe("hostnames and ip addresses", function()
    ...
    describe("parsing", function()
      ...
      it("validates addresses", function()
        assert.are.same({address = "1.2.3.4", type = "ipv4", port = 80}, utils.normalize_ip("1.2.3.4:80"))
        assert.are.same({address = "1.2.3.4", type = "ipv4", port = nil}, utils.normalize_ip("1.2.3.4"))
        assert.are.same({address = "0000:0000:0000:0000:0000:0000:0000:0001", type = "ipv6", port = 80}, utils.normalize_ip("[::1]:80"))
        assert.are.same({address = "0000:0000:0000:0000:0000:0000:0000:0001", type = "ipv6", port = nil}, utils.normalize_ip("::1"))
        assert.are.same({address = "localhost", type = "name", port = 80}, utils.normalize_ip("localhost:80"))
        assert.are.same({address = "mashape.com", type = "name", port = nil}, utils.normalize_ip("mashape.com"))
    ...
    describe("formatting", function()
      it("correctly formats addresses", function()
        assert.are.equal("1.2.3.4", utils.format_ip("1.2.3.4"))
        assert.are.equal("1.2.3.4:80", utils.format_ip("1.2.3.4", 80))
        assert.are.equal("::1", utils.format_ip("::1"))
        assert.are.equal("[::1]:80", utils.format_ip("::1", 80))
        assert.are.equal("localhost", utils.format_ip("localhost"))
        assert.are.equal("mashape.com:80", utils.format_ip("mashape.com", 80))
        -- passthrough (string)
        assert.are.equal("1.2.3.4", utils.format_ip(utils.normalize_ipv4("1.2.3.4")))
        assert.are.equal("1.2.3.4:80", utils.format_ip(utils.normalize_ipv4("1.2.3.4:80")))
        assert.are.equal("0000:0000:0000:0000:0000:0000:0000:0001", utils.format_ip(utils.normalize_ipv6("::1")))
        assert.are.equal("[0000:0000:0000:0000:0000:0000:0000:0001]:80", utils.format_ip(utils.normalize_ipv6("[::1]:80")))
        assert.are.equal("localhost", utils.format_ip(utils.check_hostname("localhost")))
        assert.are.equal("mashape.com:80", utils.format_ip(utils.check_hostname("mashape.com:80")))
        -- passthrough general (table)
        assert.are.equal("1.2.3.4", utils.format_ip(utils.normalize_ip("1.2.3.4")))
        assert.are.equal("1.2.3.4:80", utils.format_ip(utils.normalize_ip("1.2.3.4:80")))
        assert.are.equal("0000:0000:0000:0000:0000:0000:0000:0001", utils.format_ip(utils.normalize_ip("::1")))
        assert.are.equal("[0000:0000:0000:0000:0000:0000:0000:0001]:80", utils.format_ip(utils.normalize_ip("[::1]:80")))
        assert.are.equal("localhost", utils.format_ip(utils.normalize_ip("localhost")))
        assert.are.equal("mashape.com:80", utils.format_ip(utils.normalize_ip("mashape.com:80")))
        -- passthrough errors
        local one, two = utils.format_ip(utils.normalize_ipv4("1.2.3.4.5"))
        assert.are.equal("nilstring", type(one)..type(two))
        local one, two = utils.format_ip(utils.normalize_ipv6("not ipv6 ..."))
        assert.are.equal("nilstring", type(one)..type(two))
        local one, two = utils.format_ip(utils.check_hostname("//bad..name\\:123"))
        assert.are.equal("nilstring", type(one)..type(two))
        local one, two = utils.format_ip(utils.normalize_ip("m a s h a p e.com:80"))
        assert.are.equal("nilstring", type(one)..type(two))
      end)
    end)
  end)
