...
describe("admin_gui template", function()
  describe("admin_gui.generate_kconfig() - proxied", function()
    ...
    it("should generates the appropriate kconfig", function()
      ...
      assert.matches("'KONG_EDITION': 'enterprise'", kconfig_content, nil, true)
      -- XXX EE [[
      ...
      assert.matches("'RBAC_HEADER': 'Kong-Admin-Token'", kconfig_content, nil, true)
    ...
    it("should regenerates the appropriate kconfig from another call", function()
      ...
      assert.matches("'KONG_EDITION': 'enterprise'", new_content, nil, true)
      -- XXX EE [[
      ...
      assert.matches("'RBAC_HEADER': 'Kong-Admin-Token'", new_content, nil, true)
