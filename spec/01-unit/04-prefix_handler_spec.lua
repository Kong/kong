  ...
  describe("compile_kong_gui_include_conf()", function ()
    describe("admin_gui_path", function ()
      it("set admin_gui_path to /", function ()
        ...
        assert.matches("location%s+~%*%s+%^%(%?<path>/monacoeditorwork/%.%*%)%$", kong_gui_include_conf)   -- [[ EE only ]]
      ...
      it("set admin_gui_path to /manager", function ()
        ...
        assert.matches("location%s+~%*%s+%^/manager%(%?<path>/monacoeditorwork/%.%*%)%$", kong_gui_include_conf)   -- [[ EE only ]]
