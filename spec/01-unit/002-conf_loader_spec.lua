...
describe("Configuration loader", function()
  ...
  it("parses IPv6 from proxy_listen/admin_listen", function()
    ...
    assert.equal("[0000:0000:0000:0000:0000:0000:0000:0000]", conf.proxy_servers[1].listeners[1].ip)
    assert.equal(8000, conf.proxy_servers[1].listeners[1].port)
    assert.equal(false, conf.proxy_servers[1].listeners[1].ssl)
    assert.equal(false, conf.proxy_servers[1].listeners[1].http2)
    assert.equal("[0000:0000:0000:0000:0000:0000:0000:0000]:8000", conf.proxy_servers[1].listeners[1].listener)

    assert.equal("[0000:0000:0000:0000:0000:0000:0000:0000]", conf.proxy_servers[1].listeners[2].ip)
    assert.equal(8443, conf.proxy_servers[1].listeners[2].port)
    assert.equal(true, conf.proxy_servers[1].listeners[2].ssl)
    assert.equal(false, conf.proxy_servers[1].listeners[2].http2)
    assert.equal("[0000:0000:0000:0000:0000:0000:0000:0000]:8443 ssl", conf.proxy_servers[1].listeners[2].listener)
  end)
