...
describe("rockspec/meta", function()
  ...
  describe("meta", function()
    ...
    it("has a _DEPENDENCIES field", function()
      ...
      assert.is_string(meta._DEPENDENCIES.nginx_from)
      assert.is_string(meta._DEPENDENCIES.nginx_to)
      assert.is_string(meta._DEPENDENCIES.serf_from)
      assert.is_string(meta._DEPENDENCIES.serf_to)
    end)
  end)
