...
describe("Configuration loader", function()
  it("loads the defaults", function()
    ...
    assert.same(true, conf.admin_http2_enabled)
    assert.same(true, conf.proxy_http2_enabled)
  end)
  ...
  it("extracts flags, ports and listen ips from proxy_listen/admin_listen/admin_gui_listen", function()
    ...
    assert.equal(true, conf.proxy_http2_enabled)
  end)
  it("parses IPv6 from proxy_listen/admin_listen/admin_gui_listen", function()
    ...
    assert.equal(false, conf.proxy_http2_enabled)
  end)
    ...
    describe("SSL", function()
      ...
      describe("status", function()
        ...
        it("supports HTTP/2", function()
          ...
          assert.same(true, conf.status_http2_enabled)
        end)
      end)
