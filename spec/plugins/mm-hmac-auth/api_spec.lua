...
describe("HMAC Auth Credentials API", function()
  ...
  describe("/consumers/:consumer/mm-hmac-auth/", function()
    ...
    setup(function()
      ...
      BASE_URL = spec_helper.API_URL.."/consumers/bob/mm-hmac-auth/"
    end)
    ...
    describe("PUT", function()
      setup(function()
        spec_helper.get_env().dao_factory.mm_hmacauth_credentials:delete({id = credential.id})
      end)
  ...
  describe("/consumers/:consumer/mm-hmac-auth/:id", function()
