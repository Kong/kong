...
describe("LDAP-AUTH Plugin", function()
  setup(function()
    ...
    spec_helper.insert_fixtures {
      ...
      plugin = {
        {name = "ldap-auth", config = {ldap_protocol = "ldap", ldap_host = "ldap.forumsys.com", ldap_port = "389", start_tls = false, base_dn = "dc=example,dc=com", attribute = "uid"}, __api = 1},
        {name = "ldap-auth", config = {ldap_protocol = "ldap", ldap_host = "ldap.forumsys.com", ldap_port = "389", start_tls = false, base_dn = "dc=example,dc=com", attribute = "uid", hide_credentials = true}, __api = 2},
      }
    }
