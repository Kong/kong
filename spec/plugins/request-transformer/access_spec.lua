...
describe("Request Transformer", function()
  ...
  describe("Test replace", function()
    ...
    it("should replace specified parameters on POST", function()
    ...
    it("should not add as new parameter if parameter does not exist on POST", function()
  ...
  describe("Test add", function()
    ...
    it("should add new parameter on POST", function()
    ...
    it("should not change or append value to parameter on POST when parameter exists", function()
      local response, status = http_client.post(STUB_POST_URL, { hello = "world"}, {host = "test1.com"})
      local body = cjson.decode(response)
      assert.equal(200, status)
      assert.equal("world", body.postData.params["hello"])
