...
build = {
  ...
  modules = {
    ...
    ["kong.tools.http_constants"] = "kong/tools/http_constants.lua",
    ...
    ["kong.pdk.private.response.handler.grpc"] = "kong/pdk/private/response/handler/grpc.lua",
    ["kong.pdk.private.response.handler.json"] = "kong/pdk/private/response/handler/json.lua",
    ["kong.pdk.private.response.handler.string"] = "kong/pdk/private/response/handler/string.lua",
    ["kong.pdk.private.response.handler.utils"] = "kong/pdk/private/response/handler/utils.lua",
