...
For a no-downtime migration from a 1.0 cluster to a 1.1 cluster,
...
2. Both 1.0 and 1.1 nodes can now run simultaneously on the same
   datastore. Start provisioning 1.1 nodes, but do not use their
   Admin API yet. Prefer making Admin API requests to your 1.0 nodes
   instead.
