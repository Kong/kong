...
build = {
  ...
  modules = {
    ...
    ["kong.clustering.telemetry_dispatcher"] = "kong/clustering/telemetry_dispatcher.lua",
    ...
    ["kong.enterprise_edition.counters"] = "kong/enterprise_edition/counters/init.lua",
    ["kong.enterprise_edition.counters.sales"] = "kong/enterprise_edition/counters/sales/init.lua",
    ["kong.enterprise_edition.counters.sales.strategies.common"] = "kong/enterprise_edition/counters/sales/strategies/common.lua",
    ["kong.enterprise_edition.counters.sales.strategies.postgres"] = "kong/enterprise_edition/counters/sales/strategies/postgres/init.lua",
    ["kong.enterprise_edition.counters.sales.strategies.off"] = "kong/enterprise_edition/counters/sales/strategies/off/init.lua",
    ["kong.enterprise_edition.counters.sales.strategies.clustering"] = "kong/enterprise_edition/counters/sales/strategies/clustering/init.lua",
    ...
    ["kong.enterprise_edition.pdk.private.websocket"] = "kong/enterprise_edition/pdk/private/websocket.lua",
    ["kong.enterprise_edition.pdk.websocket"] = "kong/enterprise_edition/pdk/websocket.lua",
    ...
    ["kong.enterprise_edition.runloop.websocket"] = "kong/enterprise_edition/runloop/websocket.lua",
    ["kong.enterprise_edition.runloop.websocket.proxy"] = "kong/enterprise_edition/runloop/websocket/proxy.lua",
    ...
    ["kong.enterprise_edition.debug_session"] = "kong/enterprise_edition/debug_session/init.lua",
    ["kong.enterprise_edition.debug_session.shm"] = "kong/enterprise_edition/debug_session/shm.lua",
    ["kong.enterprise_edition.debug_session.reporter"] = "kong/enterprise_edition/debug_session/reporter.lua",
    ["kong.enterprise_edition.debug_session.context"] = "kong/enterprise_edition/debug_session/context.lua",
    ["kong.enterprise_edition.debug_session.events"] = "kong/enterprise_edition/debug_session/events.lua",
    ["kong.enterprise_edition.debug_session.updates"] = "kong/enterprise_edition/debug_session/updates.lua",
    ["kong.enterprise_edition.debug_session.sampler"] = "kong/enterprise_edition/debug_session/sampler/init.lua",
    ...
    ["kong.enterprise_edition.db.migrations.enterprise.007_1500_to_1504"] = "kong/enterprise_edition/db/migrations/enterprise/007_1500_to_1504.lua",
    ...
    ["kong.enterprise_edition.db.migrations.enterprise.010_1500_to_2100"] = "kong/enterprise_edition/db/migrations/enterprise/010_1500_to_2100.lua",
    ...
    ["kong.enterprise_edition.db.migrations.enterprise.021_3700_to_3800_1"] = "kong/enterprise_edition/db/migrations/enterprise/021_3700_to_3800_1.lua",
    ["kong.enterprise_edition.db.migrations.enterprise.022_3800_to_3900"] = "kong/enterprise_edition/db/migrations/enterprise/022_3800_to_3900.lua",
    ...
    ["kong.portal.workspace_config"] = "kong/portal/workspace_config.lua",
    ...
    ["kong.analytics"] = "kong/analytics/init.lua",
    ...
    ["kong.db.dao.custom_plugins"] = "kong/db/dao/custom_plugins.lua",
    ...
    ["kong.db.schema.entities.custom_plugins"] = "kong/db/schema/entities/custom_plugins.lua",
    ...
    ["kong.pdk.private.ja4"] = "kong/pdk/private/ja4.lua",
    ...
    ["kong.pdk.websocket"] = "kong/pdk/websocket.lua",
    ...
    ["kong.plugins.basic-auth.migrations.enterprise"] = "kong/plugins/basic-auth/migrations/enterprise/init.lua",
    ["kong.plugins.basic-auth.migrations.enterprise.001_1500_to_2100"] = "kong/plugins/basic-auth/migrations/enterprise/001_1500_to_2100.lua",
    ...
    ["kong.plugins.jwt.migrations.enterprise"] = "kong/plugins/jwt/migrations/enterprise/init.lua",
    ["kong.plugins.jwt.migrations.enterprise.001_1500_to_2100"] = "kong/plugins/jwt/migrations/enterprise/001_1500_to_2100.lua",
    ...
    ["kong.plugins.jwt-signer.daos.jwt_signer_jwks"] = "kong/plugins/jwt-signer/daos/jwt_signer_jwks.lua",
    ["kong.plugins.jwt-signer.strategies.off.jwt_signer_jwks"] = "kong/plugins/jwt-signer/strategies/off/jwt_signer_jwks.lua",
    ...
    ["kong.plugins.hmac-auth.migrations.enterprise"] = "kong/plugins/hmac-auth/migrations/enterprise/init.lua",
    ["kong.plugins.hmac-auth.migrations.enterprise.001_1500_to_2100"] = "kong/plugins/hmac-auth/migrations/enterprise/001_1500_to_2100.lua",
    ...
    ["kong.llm.schemas.auth"] = "kong/llm/schemas/auth.lua",
    ["kong.llm.schemas.embeddings"] = "kong/llm/schemas/embeddings.lua",
    ...
    -- XXX EE [[
    ["kong.openid-connect"]                = "kong/openid-connect/init.lua",
