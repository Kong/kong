...
def common_suites(expect, libxcrypt_no_obsolete_api: bool = False, skip_libsimdjson_ffi: bool = False, skip_nginx_debug: bool = True):
    # file existence
    ...
    expect("/etc/kong/kong.logrotate", "logrotate config should have 0644 permissions").mode.equals("0644")
