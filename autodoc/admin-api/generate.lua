...
local function write_admin_api(filename, data, title)
  ...
  outfd:write("#  https://github.com/Kong/kong/blob/master/scripts/autodoc/admin-api/data/admin-api.lua\n")
  outfd:write("#  or its associated files instead.\n")
  outfd:write("#\n")
  outfd:write("title: " .. utils.titleize(title) .. "\n")
  outfd:write("source_url: https://github.com/Kong/kong/blob/master/scripts/autodoc/admin-api/data/admin-api.lua\n")
