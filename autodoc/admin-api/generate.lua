...
-- XXX Not sure this is the right call
local ok, ee_admin_api_data = pcall(require, "autodoc.data.ee-admin-api")
if not ok then
  ee_admin_api_data = {}
end
...
local function assert_data(value, description)
  if value == nil then
    error("\n\n" ..
          "****************************************\n" ..
          "Missing " .. description .. "\n" ..
          "-- please document it in autodoc/data/(ee-)?admin-api.lua\n" ..
          "****************************************\n", 2)
  end
