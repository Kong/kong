  ...
  entities = {
    ...
    routes = {
      ...
      fields = {
        ...
        protocols = {
          description = [[
            An array of the protocols this Route should allow. To allow only one protocol, send a string value. See the [Route Object](#route-object) section for a list of accepted protocols. When set to only `"https"`,
