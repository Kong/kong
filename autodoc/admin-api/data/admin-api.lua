  ...
  entities = {
    ...
    upstreams = {
      ...
      fields = {
        ...
        ["slots"] = { description = [[The maximum number of slots in the `round-robin` load balancer algorithm or the actual number of slots in the `consistent-hashing` algorithm (`10`-`65536`).]] },
