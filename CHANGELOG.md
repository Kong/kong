...
:warning: This release includes patches to OpenResty 1.13.6.2 fixing
vulnerabilities found in NGINX modules HTTP/2 and mp4 (CVE-2019-9511
...
[1.2.2]: https://github.com/Kong/kong/compare/1.2.0...1.2.2
