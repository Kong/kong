...
This major release introduces more flexible management of keys, dynamic log
level, fixed dataplane ID, HTTP forward proxy support, and other features
to help ease management. Various plugins are also extended.
Internal changes are also made to improve Kong's performance.
As it is a major release, users are advised
