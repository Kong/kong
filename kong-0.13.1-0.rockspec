...
build = {
  ...
  modules = {
    ...
    ["kong.enterprise_edition.dao.migrations.acl.postgres"] = "kong/enterprise_edition/dao/migrations/acl/postgres.lua",
    ["kong.enterprise_edition.dao.migrations.acl.cassandra"] = "kong/enterprise_edition/dao/migrations/acl/cassandra.lua",
    ["kong.enterprise_edition.dao.migrations.basic-auth.postgres"] = "kong/enterprise_edition/dao/migrations/basic-auth/postgres.lua",
    ["kong.enterprise_edition.dao.migrations.basic-auth.cassandra"] = "kong/enterprise_edition/dao/migrations/basic-auth/cassandra.lua",
    ["kong.enterprise_edition.dao.migrations.hmac-auth.postgres"] = "kong/enterprise_edition/dao/migrations/hmac-auth/postgres.lua",
    ["kong.enterprise_edition.dao.migrations.hmac-auth.cassandra"] = "kong/enterprise_edition/dao/migrations/hmac-auth/cassandra.lua",
    ["kong.enterprise_edition.dao.migrations.jwt.postgres"] = "kong/enterprise_edition/dao/migrations/jwt/postgres.lua",
    ["kong.enterprise_edition.dao.migrations.jwt.cassandra"] = "kong/enterprise_edition/dao/migrations/jwt/cassandra.lua",
    ["kong.enterprise_edition.dao.migrations.key-auth.postgres"] = "kong/enterprise_edition/dao/migrations/key-auth/postgres.lua",
    ["kong.enterprise_edition.dao.migrations.key-auth.cassandra"] = "kong/enterprise_edition/dao/migrations/key-auth/cassandra.lua",
    ["kong.enterprise_edition.dao.migrations.oauth2.postgres"] = "kong/enterprise_edition/dao/migrations/oauth2/postgres.lua",
