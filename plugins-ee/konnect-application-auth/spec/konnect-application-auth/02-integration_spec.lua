  ...
  describe(PLUGIN_NAME .. ": (access) [#" .. strategy .. "]", function()
        ...
        name = "post-function",
          ...
          config = {
            header_filter = {[[
              ...
              kong.response.set_header("x-authorization-scope-id", app_ctx and app_ctx.authorization_scope_id or "nil")
            ]]}
          }
      }
    ...
    describe("Key-auth application context", function()
      it("maps the application context when found", function()
        ...
        assert.are.same(scope, res.headers["x-authorization-scope-id"])
      ...
      it("doesnt map the application context when not found", function()
        ...
        assert.are.same("nil", res.headers["x-authorization-scope-id"])
