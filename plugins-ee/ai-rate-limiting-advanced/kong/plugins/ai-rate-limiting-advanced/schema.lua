  ...
  fields = {
    ...
    { config = {
        ...
        fields = {
          ...
          { tokens_count_strategy = { description = "What tokens to use for cost calculation. Available values are: `total_tokens` `prompt_tokens`, and `completion_tokens`.", type = "string",
