...
local llm_provider_schema = {
  ...
  fields = {
    ...
    { name = { description = "The LLM provider to which the rate limit applies.",
            type = "string",
            one_of = { "openai", "azure", "anthropic", "cohere", "mistral", "llama2", "requestPrompt" }, 
            required = true,
    }},
  ...
  fields = {
    ...
    { config = {
        ...
        fields = {
          ...
          { tokens_count_strategy = { description = "What tokens to use for cost calculation. Available values are: `total_tokens` `prompt_tokens`, `completion_tokens` or `total_cost`.", type = "string",
