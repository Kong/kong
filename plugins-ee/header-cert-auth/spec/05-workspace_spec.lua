...
local SNI_CACHE_KEY = "header-cert-auth:cert_enabled_snis"
...
for _, strategy in strategies() do
  describe("Plugin: header-cert-auth (routes of different workspaces can update normally) [#" .. strategy .. "]", function()
    ...
    lazy_setup(function()
      ...
      assert(bp.plugins:insert {
        ...
        config = { ca_certificates = { ca_cert.id, sub_ca_cert.id, other_ca_cert.id, },
                   skip_consumer_lookup = true, certificate_header_name = "ssl-client-cert", certificate_header_format = "base64_encoded", secure_source = false },
      })
