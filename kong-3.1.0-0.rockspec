...
build = {
  ...
  modules = {
    ...
    ["kong.db.dao.jwks"] = "kong/db/dao/jwks.lua",
    ["kong.db.dao.jwk_sets"] = "kong/db/dao/jwk_sets.lua",
    ["kong.db.schema.entities.jwks"] = "kong/db/schema/entities/jwks.lua",
    ["kong.db.schema.entities.jwk_sets"] = "kong/db/schema/entities/jwk_sets.lua",
