...
build = {
  ...
  modules = {
    ...
    ["kong.public.01.cache"] = "kong/public/01/cache.lua",
    ["kong.public.01.00.01.cache"] = "kong/public/01/00/01/cache.lua",
    ["kong.public.01.configuration"] = "kong/public/01/configuration.lua",
    ["kong.public.01.ctx"] = "kong/public/01/ctx.lua",
    ["kong.public.01.dao"] = "kong/public/01/dao.lua",
    ["kong.public.01.db"] = "kong/public/01/db.lua",
    ["kong.public.01.dns"] = "kong/public/01/dns.lua",
    ["kong.public.01.http"] = "kong/public/01/http.lua",
    ["kong.public.01.ipc"] = "kong/public/01/ipc.lua",
    ["kong.public.01.log"] = "kong/public/01/log.lua",
    ["kong.public.01.request"] = "kong/public/01/request.lua",
    ["kong.public.01.response"] = "kong/public/01/response.lua",
    ["kong.public.01.shm"] = "kong/public/01/shm.lua",
    ["kong.public.01.timers"] = "kong/public/01/timers.lua",
    ["kong.public.01.utils"] = "kong/public/01/utils.lua",
    ["kong.public.01.upstream"] = "kong/public/01/upstream/init.lua",
    ["kong.public.01.upstream.response"] = "kong/public/01/upstream/response.lua",
