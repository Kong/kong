...
build = {
  ...
  modules = {
    ...
    ["kong.cli.utils.start"] = "kong/cli/utils/start.lua",
    ["kong.cli.utils.stop"] = "kong/cli/utils/stop.lua",
    ...
    ["kong.plugins.keyauth.dao.cassandra"] = "kong/plugins/keyauth/dao/cassandra.lua",
    ...
    ["kong.web.routes.applications"] = "kong/web/routes/applications.lua",
    ["kong.web.routes.plugins"] = "kong/web/routes/plugins.lua",
