...
local deep_merge = require "kong.tools.table".deep_merge
...
for _, strategy in helpers.all_strategies() do
  -- in this test we test two targets with round robin strategy:
  -- always set the unreachable target with higher weight so that plugin picks it first
  -- then it should failover and return expected (reachable) status
  describe(PLUGIN_NAME .. ": (failover) [#" .. strategy .. "]", function()
    local client
    ...
    lazy_setup(function()
      ...
      bp.plugins:insert {
        ...
        config = {
          targets = { 
            deep_copy(model_template),
            deep_merge(deep_copy(model_template), {
              weight = 1000,
              model = {
                options = {
                  upstream_url = "http://127.0.0.1:65530/llm/v1/chat/good",
                }
              },
            })
          },
      ...
      local chat_noliveupstream = assert(bp.routes:insert {
        service = empty_service,
        protocols = { "http" },
        strip_path = true,
        paths = { "/openai/llm/v1/chat/noliveupstream" }
      })
      bp.plugins:insert {
        name = PLUGIN_NAME,
        route = { id = chat_noliveupstream.id },
        config = {
          targets = { 
            deep_merge(deep_copy(model_template), {
              model = {
        ...
        config = {
          targets = {
            ...
            deep_merge(deep_copy(model_template), {
              ...
              model = {
                options = {
                  upstream_url = "http://127.0.0.1:65530/llm/v1/chat/bad_upstream_response",
                }
              },
            }) },
        },
        ...
        config = {
          targets = {
            ...
            deep_merge(deep_copy(model_template), {
              ...
              model = {
                options = {
                  upstream_url = "http://127.0.0.1:65530/llm/v1/completions/good",
                }
              },
            }) },
        },
      ...
      local embedings_good = assert(bp.routes:insert {
        service = empty_service,
        protocols = { "http" },
        strip_path = true,
        ...
        config = {
          targets = {
            ...
            deep_merge(deep_copy(model_template), {
              ...
              model = {
                options = {
                  upstream_url = "http://127.0.0.1:65530/llm/v1/embeddings/good",
                }
              },
            }) },
        },
        ...
        config = {
          targets = {
            ...
            deep_merge(deep_copy(model_template), {
              ...
              model = {
                options = {
                  upstream_url = "http://127.0.0.1:65530/llm/v1/chat/bad_request",
                }
              },
            }) },
        },
        ...
        config = {
          targets = {
            ...
            deep_merge(deep_copy(model_template), {
              ...
              model = {
                options = {
                  upstream_url = "http://127.0.0.1:65530/llm/v1/completions/bad_request",
                }
              },
            }) },
        },
        ...
        config = {
          targets = {
            ...
            deep_merge(deep_copy(model_template), {
              ...
              model = {
                options = {
                  upstream_url = "http://127.0.0.1:65530/llm/v1/chat/internal_server_error",
                }
              },
            }) },
        },
    ...
    describe("openai general", function()
      it("test setup sanity", function()
        local r = client:get("/openai/llm/v1/chat/noliveupstream", {
          headers = {
        ...
        -- with no upstream reachable this should fail
