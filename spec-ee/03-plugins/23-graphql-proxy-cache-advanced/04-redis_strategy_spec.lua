...
local redis_strategy = require "kong.plugins.graphql-proxy-cache-advanced.strategies.redis"
...
for redis_description, redis_configuration in pairs(redis_test_configurations()) do
  describe("graphql-proxy-cache-advanced: Redis #" .. redis_description, function()
    local strategy
    local red
    ...
    describe(":store [#" .. redis_description .. "]", function()
      it("stores a cache object", function()
        ...
        obj.body_len = tonumber(obj.body_len)
