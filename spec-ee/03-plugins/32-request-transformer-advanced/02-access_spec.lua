...
describe("Plugin: request-transformer-advanced(access) [#" .. strategy .. "] untrusted_lua=off", function()
  local client
...
describe("Plugin: request-transformer-advanced(access) [#" .. strategy .. "] untrusted_lua=on", function()
  local client
...
describe("Plugin: request-transformer-advanced(access) [#" .. strategy .. "] untrusted_lua=sandbox", function()
  local client
...
describe("Plugin: request-transformer-advanced(access) [#" .. strategy .. "] untrusted_lua_sandbox_requires", function()
  local client
...
describe("Plugin: request-transformer-advanced(access) [#" .. strategy .. "] untrusted_lua_sandbox_environment", function()
  local client
...
describe("Plugin: request-transformer-advanced (thread safety) [#" .. strategy .. "]", function()
  local db_strategy = strategy ~= "off" and strategy or nil
