...
describe("Token tests", function ()
  ...
  describe("Proof of Possession #dpop mode - verify_client_dpop()", function()
    ...
    it("should return true when introspection data is bound to the right key", function()
      ...
      local ok, err_typ, err_msg = t:verify_client_dpop(opaque_token, dpop_fixtures.KEY_INTROSPECTION_DATA, true, dpop_req_info, options)
      assert.is_nil(err_msg)
      assert.is_nil(err_typ)
      assert.is_truthy(ok)
    end)
    ...
    it("should return err when introspection data is not bound to any key", function()
      ...
      local ok, err_typ, err_msg = t:verify_client_dpop(opaque_token, dpop_fixtures.NO_KEY_INTROSPECTION_DATA, true, dpop_req_info, options)
    ...
    it("should return err when introspection data is bound to the wrong key", function()
      ...
      local ok, err_typ, err_msg = t:verify_client_dpop(opaque_token, dpop_fixtures.WRONG_KEY_INTROSPECTION_DATA, true, dpop_req_info, options)
