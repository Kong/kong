...
for _, strategy in helpers.all_strategies({"postgres", "off"}) do
    ...
    describe("Plugins Iterator - Tripple Scoping - #Consumer #Route #Service on #" .. strategy, function()
        ...
        lazy_setup(function()
            ...
            insert(must_not_have_headers, pf:consumer_group_service_route())
            ...
            assert.is_equal(#must_not_have_headers, 11)
