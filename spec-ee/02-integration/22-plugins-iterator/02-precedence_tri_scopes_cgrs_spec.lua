...
for _, strategy in helpers.all_strategies({"postgres", "off"}) do
    ...
    describe("Plugins Iterator - Tripple Scoping - #ConsumerGroup #Route #Servie on #" .. strategy, function()
        ...
        lazy_setup(function()
            ...
            expected_header = pf:consumer_group_service_route()
            ...
            assert.is_equal(#must_not_have_headers, 10)
