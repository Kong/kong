...
describe("vault ttl and rotation (#" .. attachment_point .. "_" .. vault.name .. ")", function()
  ...
  it("updates plugin config references", function()
    ...
    check_plugin_secret("updated_once", "updated_once", 21)
    ...
    check_plugin_secret("updated_twice", "updated_twice", 21)
  ...
  it("respects resurrect_ttl times", function ()
    ...
    -- inbetween
    check_plugin_secret("init", nil, 21, NESTED_HEADER_2)
    ...
    check_plugin_secret("created_again", nil, 21, NESTED_HEADER_2)
    ...
    check_plugin_secret("updated_yet_again", nil, 21, NESTED_HEADER_2)
  end)
end)
