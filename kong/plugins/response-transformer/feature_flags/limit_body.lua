...
local function init_worker()
  ...
  local limit = tonumber(feature_flags.get_feature_value(VALUES.RESPONSE_TRANSFORMER_LIMIT_BODY_SIZE))
  if limit then
...
local function header_filter()
  ...
  if content_length > rt_body_size_limit then
    ngx_log(ngx_ERR, "[response-transformer] { \"message\": \"response body size limit exceeded\", \"allowed\" : " ..
