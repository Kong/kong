  ...
  fields = {
    ...
    { config = {
        ...
        fields = {
          ...
          { strategy = { description = "The backing data store in which to hold cache entities. The only accepted value is `memory`.", type = "string",
            one_of = strategies.STRATEGY_TYPES,
            required = true,
          }},
          { cache_control = { description = "When enabled, respect the Cache-Control behaviors defined in [RFC7234](https://tools.ietf.org/html/rfc7234#section-5.2).", type = "boolean",
            default = false,
            required = true,
          }},
          { ignore_uri_case = {
