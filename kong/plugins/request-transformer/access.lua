...
local function transform_querystrings(conf, template_env)
  ...
  local querystring = kong_table.cycle_aware_deep_copy(template_env.query_params)
...
function _M.execute(conf)
  ...
  if lua_enabled and sandbox_enabled then
    ...
    template_env = kong_table.cycle_aware_deep_copy(sandbox.configuration.environment)
