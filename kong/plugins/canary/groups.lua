-- This file is a copy of the extracted file from PR https://github.com/Kong/kong/pull/3486
-- so once that code lands somewhere, this file should be removed and replaced by
-- calls to that relocated logic.
