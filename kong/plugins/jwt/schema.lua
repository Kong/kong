  ...
  fields = {
    ...
    { config = {
        ...
        fields = {
          ...
          { key_claim_name = { description = "The name of the claim in which the key identifying the secret must be passed. Starting with version 0.13.1, the plugin will attempt to read this claim from the JWT payload and the header, in that order.", type = "string", default = "iss" }, },
