...
local statsd_logger    = require "kong.plugins.statsd-advanced.statsd_logger"
...
if ngx.config.ngx_lua_version >= 10011 then
  -- kong is already requiring this elsewhere, require this explicitly here
...
local function log(premature, conf, message)
  ...
  if err then
    ngx_log(NGX_ERR, "[statsd-advanced] failed to create Statsd logger: ", err)
    return
  end
