...
return {
  ...
  fields = {
    { id = typedefs.uuid, },
    { name = { description = "The name of the Plugin that's going to be added. Currently, the Plugin must be installed in every Kong instance separately.", type = "string", required = true, }, },
