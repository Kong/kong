...
local r =  {
  ...
  fields = {
    ...
    { name = { description = "This is a hostname, which must be equal to the host of a Service.",type = "string", required = true, unique = true, custom_validator = validate_name, indexed = true }, },
