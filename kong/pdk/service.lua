...
local function new()
  ...
  -- or stream [proxy_ssl_trusted_certificate](https://nginx.org/en/docs/stream/ngx_stream_proxy_module.html#proxy_ssl_trusted_certificate)
  ...
  -- has to be enabled with either the http [proxy_ssl_verify](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_verify) directive
  -- or stream [proxy_ssl_verify](https://nginx.org/en/docs/stream/ngx_stream_proxy_module.html#proxy_ssl_verify) directive
  -- or using the [kong.service.set_tls_verify](#kongserviceset_tls_verify) function.
  --
  ...
  -- has to be enabled with either the http [proxy_ssl_verify](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_verify) directive
  -- or stream [proxy_ssl_verify](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_ssl_verify) directive
  -- or using the [kong.service.set_tls_verify](#kongserviceset_tls_verify) function.
  --
