...
local function new(pdk, major_version)
  ...
  -- @treturn number status The HTTP status code currently set for the downstream response
  -- @usage
  ...
  -- @treturn table headers A table representation of the headers in the response
