...
local function new(self)
  ...
  function _REQUEST.get_body(mimetype, max_args, max_allowed_file_size)
    ...
    elseif find(content_type_lower, constants.CONTENT_TYPE_POST, 1, true) == 1 then
      ...
      if type(json) ~= "table" then
        return nil, "invalid json body", constants.CONTENT_TYPE_POST
      end

      return json, nil, constants.CONTENT_TYPE_POST
