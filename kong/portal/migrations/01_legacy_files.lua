...
{{/layout}}
  ...
  {
    type = "page",
    name = "unauthenticated/account/invalidate-verification",
    contents = [[{{#> unauthenticated/layout pageTitle="Invalidate Account Verification" }}

  {{#*inline "content-block"}}
    <div class="app-container">
      <div id="portal-dashboard" class="page-wrapper indent" page="invalidate-account-verification"></div>
    </div>
  {{/inline}}
...
@media all and (min-width: 1201px) {
  ...
  {
    type = "page",
    name = "unauthenticated/account/verify",
    contents = [[{{#> unauthenticated/layout pageTitle="Reset Password" }}

  {{#*inline "content-block"}}
    <div class="app-container">
      <div id="portal-dashboard" class="page-wrapper indent" page="verify-account"></div>
    </div>
  {{/inline}}
...
<div id="search-results" :class="{ active: !isLoading }">
  ...
  <div class="search-item-container expanded">
    <div class="search-row item"
      ...
      @click="goToPage(buildUrl(file.path))">
...
window.helpers.fetchPageList = (files) => {
  ...
  {
    type = "page",
    name = "unauthenticated/account/resend-verification",
    contents = [[{{#> unauthenticated/layout pageTitle="Resend Account Verification" }}

  {{#*inline "content-block"}}
    <div class="app-container">
      <div id="portal-dashboard" class="page-wrapper indent" page="resend-account-verification"></div>
    </div>
  {{/inline}}
