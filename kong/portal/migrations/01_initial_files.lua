...
{{#*inline "content-block"}}
  <div class="app-container authentication">
      <h2>Unauthorized</h2>
      <p style="max-width: 400px; text-align: left;">You are unauthorized to view this page because you are not an approved or registered developer. Please try <a href="/login">logging in</a>, or <a href="/register">signing up</a> for access.</p>
  </div>
{{/inline}}
...
{{/unauthenticated/layout}}]],
  ...
  {
    type = "page",
    name = "documentation/api1",
    contents = [[{{#> layout pageTitle="Dev Portal Files API"}}
          ...
          <div class="row container">
            <div class="column">
              ...
              {{#if authData.authType}}
                <a href="/register" class="button button-success">Create a Developer Account</a>
              {{/if}}
            </div>
            <div class="column">
        ...
        <section class="catalog">
          ...
          <div class="row container">
            <div class="catalog-item">
              ...
              <p><a href="/documentation/vitals">Read the docs</a></p>
            </div>
            <div class="catalog-item">
             <svg width="49" height="44">
              ...
              <p><a href="/documentation/files">Read the docs</a></p>
            </div>
            <div class="catalog-item">
             <svg width="48" height="48">
              ...
              <p><a href="/documentation/admin">Read the docs</a></p>
            </div>
          </div>
        </section>
          ...
          <div class="row container guides">
            <div class="column guide">
              ...
              <div class="text">
                ...
                <a href="/guides/5-minute-quickstart/" target="_blank">Continue Reading &rsaquo;</a>
              </div>
            </div>
            <div class="column guide">
              <div class="icon">
              ...
              <div class="text">
                ...
                <a href="/guides/kong-architecture-overview/" target="_blank">Continue Reading &rsaquo;</a>
              </div>
            </div>
          </div>
          <div class="row container guides">
            <div class="column guide">
              ...
              <div class="text">
                ...
                <a href="/guides/uploading-spec" target="_blank">Continue Reading &rsaquo;</a>
              </div>
            </div>
            <div class="column guide">
              <div class="icon">
              ...
              <div class="text">
                ...
                <a href="/guides/kong-vitals" target="_blank">Continue Reading &rsaquo;</a>
              </div>
            </div>
          </div>
        </section>
...
{{/unauthenticated/layout}}]],
  ...
  },
  {
    type = "partial",
    name = "sidebar-spec",
    contents = [[{{#if sidebarData}}
  <div class="sidebar-list" id="spec-sidebar">
    <ul>
      <li class="list-title">{{title}}</li>
        {{#each sidebarData}}
          <li class="submenu">
            <span class="submenu-title">{{this.tag}}</span>
            <ul class="submenu-items">
            <!-- For each Tag get tag and contents -->
            {{#each this.paths}}
              {{#each this.methods}}
                <li>
                  <a href="#operations-{{../../this.tag}}-{{this.id}}" class="method method-{{this.id}}">{{this.summary}}</a>
                </li>
              {{/each}}
            {{/each}}
          </ul>
          ...
          <div class="row container guides">
            <div class="column guide">
              ...
              <div class="text">
                ...
                <a href="/guides/kong-ee-introduction/">Continue Reading &rsaquo;</a>
              </div>
            </div>
            <div class="column guide">
              <div class="icon">
              ...
              <div class="text">
                ...
                <p>Learn the basics of Kong, make your first API Call.</p>
                <a href="/guides/5-minute-quickstart/" >Continue Reading &rsaquo;</a>
              </div>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row container guides">
            <div class="column guide">
              ...
              <div class="text">
                ...
                <a href="/guides/uploading-spec/" >Continue Reading &rsaquo;</a>
              </div>
            </div>
          ...
          <div class="row container guides">
            <div class="column guide">
              ...
              <div class="text">
                ...
                <p>Integrate data from Kong to your favorite monitoring tool.</p>
                <a href="/guides/kong-vitals/" >Continue Reading &rsaquo;</a>
              </div>
            </div>
            <div class="column guide">
              <div class="icon">
              ...
              <div class="text">
                ...
                <p>Learn the purpose and architecture of Kongs underlying components.</p>
                <a href="/guides/kong-architecture-overview/" >Continue Reading &rsaquo;</a>
              </div>
            </div>
          </div>
        </section>
...
{{/scripts-block}}]],
  ...
  },
  {
    type = "page",
    name = "about",
    contents = [[{{#> layout pageTitle="About" }}

  {{#*inline "content-block"}}
    <div class="app-container">
      <div class="page-wrapper indent">
        <h1>About</h1>
        <p>This is a sample page. You can delete it or modify it to suit your needs.</p>
      </div>
    </div>
  {{/inline}}
...
{{/layout}}]],
  ...
  {
    type = "page",
    name = "documentation/api2",
    contents = [[{{#> layout pageTitle="Vitals API"}}

  {{#* inline "content-block"}}
    <div class="app-container">
      <div class="container">
        {{> sidebar}}
        {{> spec-renderer spec="vitals"}}
      </div>
    </div>
  {{/inline}}
    ...
    <div class="app-container">
      <div class="container">
        ...
        <section class="page-wrapper kong-doc">
          ...
          <h2>Vitals API</h2>
          <p>Vitals data is available via endpoints on Kong’s Admin API. Access to these endpoints may be controlled via Admin API RBAC. The Vitals API is described in the attached OAS (Open API Spec, formerly Swagger) file <a href="/documentation/files">vitals</a></p>
...
{{/layout}}]],
  ...
  },
  {
    type = "partial",
    name = "spec-dropdown",
    contents = [[<li class="dropdownWrapper">
  <div class="header-text">
    API Reference
    <svg class="dropdown-arrow" width="10px" height="6px" viewBox="0 0 10 6" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
  ...
  <ul class="dropdown-list">
    {{#each allFiles}}
      {{#if (eq this.type 'spec')}}
        <li class="dropdown-list-item">
          <a href="{{url}}/documentation/{{this.name}}">{{this.name}}</a>
        </li>
      {{/if}}
    {{/each}}
  </ul>
    ...
    <div class="app-container">
      <div class="container">
        ...
        <section class="page-wrapper kong-doc">
          ...
          <p>To begin, go to <a href="/docs/enterprise/latest/getting-started/adding-your-api">Adding your API ›</a></p>
        </section>
      </div>
    </div>
  {{/inline}}
...
{{/layout}}]],
  ...
  {
    type = "partial",
    name = "unauthenticated/theme-css",
    contents = [[{{!--**************************************************************************
Here you can see/edit the default theme we have applied to the developer portal.
          
You can:
          
- Make changes here if you would like to modify the provided theme.
- Override styles in custom-css.hbs if you'd like to preserve the underlying
...
#header {
  ...
  background: #001E33;
  z-index: 1; }
  #header .container, #header .app-container {
    height: 100%;
      ...
      #header nav.header-nav-container {
        ...
        #header nav.header-nav-container.open {
          ...
          #header nav.header-nav-container.open:after {
            ...
            height: 100vh;
            background: rgba(0, 0, 0, 0.45);
            -webkit-animation: fadeIn 500ms ease 1 forwards;
  ...
  @media all and (max-width: 768px) {
    footer#footer {
      ...
      -webkit-box-align: center;
          -ms-flex-align: center;
              align-items: center; }
      footer#footer .container, footer#footer .app-container {
        -webkit-box-orient: vertical;
        -webkit-box-direction: normal;
            -ms-flex-direction: column;
                flex-direction: column;
    ...
    .sidebar-list ul li {
      ...
      .sidebar-list ul li.submenu {
        ...
        .sidebar-list ul li.submenu.active ul {
          height: auto;
          max-height: 9999px; }
        .sidebar-list ul li.submenu.active .submenu-title:after {
      ...
      .sidebar-list ul li .submenu-items {
        ...
        .sidebar-list ul li .submenu-items a {
          ...
          font-weight: normal;
          color: rgba(0, 0, 0, 0.7); }
          .sidebar-list ul li .submenu-items a:hover {
            color: black; }
        .sidebar-list ul li .submenu-items li.active {
          background: rgba(0, 0, 0, 0.05); }
          .sidebar-list ul li .submenu-items li.active a {
            font-weight: 500; }
      .sidebar-list ul li .method:before {
        display: none;
        width: 47px;
        margin-right: .5rem;
        padding-top: .15rem;
...
@media all and (max-width: 1300px) {
  #guides .container, #guides .app-container {
    -webkit-box-orient: vertical;
    -webkit-box-direction: normal;
        -ms-flex-direction: column;
            flex-direction: column; } }
...
definitions:
  ...
  {{#*inline "content-block"}}
    <div class="app-container">
      <div id="portal-dashboard" class="page-wrapper indent"></div>
    </div>
  {{/inline}}
...
<div id="sidebar">
  <div class="sidebar-menu">
    <div class="sidebar-list">
      <ul>
        ...
        <li><a href="/guides">Introduction</a></li>
      </ul>
    </div>
    {{> sidebar-spec title="Resources" }}
  </div>
</div>]],
    auth = true
  },
  {
    type = "partial",
    name = "kong-docs-sidebar",
    contents = [[<div id="sidebar">
  <div class="sidebar-menu">
    <div class="sidebar-list">
      <ul>
        <li class="list-title">Getting Started</li>
        <li><a href="/guides/kong-ee-introduction">Introduction</a></li>
        <li><a href="/guides/5-minute-quickstart">5 Minute guide to Kong EE</a></li>
      </ul>
    </div>
     <div class="sidebar-list">
      <ul>
      <ul>
        ...
        <li><a href="/guides/uploading-spec">Uploading Spec File</a></li>
      </ul>
      <ul>
    </div>
     <div class="sidebar-list">
      <ul>
        ...
        <li><a href="/guides/kong-architecture-overview">Kong Architecture</a></li>
        <li><a href="/guides/kong-vitals">Intro to Kong Vitals</a></li>
      </ul>
    </div>
  </div>
</div>]],
