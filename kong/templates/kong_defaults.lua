...
pg_password = NONE
pg_iam_auth = off
pg_iam_auth_assume_role_arn = NONE
pg_iam_auth_role_session_name = KongPostgres
pg_iam_auth_sts_endpoint_url = NONE
pg_ssl = off
pg_ssl_required = off
pg_ssl_verify = off
...
pg_ro_password = NONE
pg_ro_iam_auth = off
pg_ro_iam_auth_assume_role_arn = NONE
pg_ro_iam_auth_role_session_name = KongPostgres
pg_ro_iam_auth_sts_endpoint_url = NONE
pg_ro_ssl = NONE
