...
return {
  ...
  HEADERS = {
    ...
    kongsumer_ID = "X-kongsumer-ID",
    kongsumer_CUSTOM_ID = "X-kongsumer-Custom-ID",
    kongsumer_USERNAME = "X-kongsumer-Username",
    CREDENTIAL_USERNAME = "X-Credential-Username",
    RATELIMIT_LIMIT = "X-RateLimit-Limit",
    RATELIMIT_REMAINING = "X-RateLimit-Remaining",
    kongsumer_GROUPS = "X-kongsumer-Groups",
    FORWARDED_HOST = "X-Forwarded-Host",
    FORWARDED_PREFIX = "X-Forwarded-Prefix",
    ANONYMOUS = "X-Anonymous-kongsumer",
    VIA = "Via",
    SERVER = "Server"
  },
  RATELIMIT = {
